...
<head>
  ...
  <meta charset="UTF-8">
  <meta name="description" content="Women Fashion Shopping Online - Shop from a huge range of latest women clothing, shoes, makeup Kits, Watches, footwear and more for women at best price in US from Top Brands. Best Online Fashion Shopping *COD *15-Days Returns *Free Shipping.">
  <meta name="keywords" content="Online Shopping Website For Women, Women Fashion Shop, Buy Womens Clothes, Women Apparel Online Shopping US, Ladies Fashion Clothing">
...
<body>
			...
			<div class="col-md-12" style="margin-top:0px;margin-bottom:0px;">
				...
				<div class="col-md-4 col-xs-12" style="margin-top: 5px;">
					<div class="feature-box" >
						<div class="icons"> </div>
						<center><big><h5 align="center"><big><big>&#9993;</big> &nbsp; Email: </b> support@homeservice.com</big></h5>
					</div>
				</div>
	...
	<!-- NAVIGATION BAR START  -->
		<nav class="navbar navbar-default">
		    ...
		    <div class="navbar-header">
		        ...
		        <a href="#" class="navbar-brand">Home Services</a>
		    </div>
		    <!-- Collection of nav links and other content for toggling -->
		    <div id="navbarCollapse" class="collapse navbar-collapse">
		        <ul class="nav navbar-nav">
		            <li class="active"><a href="#">Home</a></li>
		            <li><a href="#trending">Services</a></li>
	...
	<!-- IMAGES START -->
<div class="row">
	<section class="women_wear" >
		<h1> Appliance Services </h1>
		<div class="col-md-12"  align="center">
			<div class=" col-md-4 col-xs-12" >
				<div>
					<a href="product.php"><img src="assets/images/image1.png" width="100%"></a>
				</div>
			</div>
			<div class=" col-md-4 col-xs-12" >
				<div>
					<a href="product1.php"><img src="assets/images/image2.png" width="100%"></a>
										
				</div>
			</div>
			<div class=" col-md-4 col-xs-12" >
				<div>
					<a href="product2.php"><img src="assets/images/image5.png" width="100%"></a>					
				</div>
			</div>
			
			<div class="col-md-4 col-xs-12" >
				<div>
					<a href="product.php"><img src="assets/images/image3.png" width="100%"></a>
				</div>
			</div>
			<div class="col-md-4 col-xs-12" >
				<div>
					<a href="product.php"><img src="assets/images/image6.png" width="100%">
				</div>
			</div>
		</div>
	</section>
	...
	<div class=" col-md-3 col-xs-12" >
		<div>
			...
			<table style="padding:5px;">
				<tr><td>
				<img src="assets/images/original.png" alt="Home Service"></td>
				<td><b>100%  Service Guarntee </b><br><br></Td></tr>
				<td><img src="assets/images/return.png" alt="Home Service"></td><td><b>24X7 Support</b>Get Assured Support<br>
				
				<br></td></tr> 
				<td></td><td><b>Get Insured Work</b>  </td></tr></table>
        </div>
	</div>
