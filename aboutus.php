    ...
    <!-- NAVIGATION BAR START  -->
        <nav class="navbar navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a href="index.php" class="navbar-brand">CHEAP SHOP</a>
            </div>
            <!-- Collection of nav links and other content for toggling -->
            <div id="navbarCollapse" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="index.php">Home</a></li>
                    <li><a href="index.php/#trending">Shop</a></li>
          ...
          <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" >
              ...
              <div class="item active">
                <img src="assets/images/banner1.jpg" id="slider_image"   >
              ...
              <div class="item">
                <img src="assets/images/banner2.jpg"  class="slider_image" >
                <div class="carousel-caption">
                  <h3></h3>
                  </div>
              </div>
              ...
              <div class="item">
                <img src="assets/images/banner3.jpg" class="slider_image" >
                <div class="carousel-caption">
                  <h3></h3>
                  </div>
              </div>
        ...
        <div>
            <form style="margin-top: 25px;">
                        <div class="form-group">
                            ...
                            <p>Home Services is leading service provider for home services and maintenance needs. After serving more than a million household customers across countries. we have now ventured to service businesses like yours across commercial and residential establishments.</p>
                        </div>
        ...
        <div>
            <div class="card-header bg-success text-white text-uppercase" style="margin-top: 25px; padding: 5px;"><i class="fa fa-home"></i> Address</div>
                <div class="card-body"><Br><br>
                    ...
                    <p>Email- support@cheapshop.com</p>
    ...
    <div class=" col-md-3 col-xs-12" >
        <div>
            ...
            <table style="padding:5px;">
                ...
                <td><b>100% ORIGINAL</b> guarantee for all products at Cheap Shop<br><br></Td></tr>
                <td><img src="assets/images/return.png" alt="Cheap Shop"></td><td><b>Return</b>  within 30days of receiving your order<br>
                
                <br></td></tr> 
                <td><img src="assets/images/delievery.png" alt="Cheap Shop"></td><td><b>Get free delivery</b>  </td></tr></table>
        </div>
    </div>
