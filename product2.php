        ...
        <div>
            <div style="margin-top: 25px;">
                        <div class="form-group">
                            <h1>Geyser </h1>
                            <h4>Get Installation/ Un-installation and Repair at Unbelievable Prices</h4>
                            <label for="name">Inclusions & Exclusions</label>
                            <ol>
                <li>Prices shown are for labour charges only.</li>
                ...
                <li>Housejoy provides a 30 day warranty on the service provided</li>
                <li>For any repair work, a quote will be given before proceeding</li>
                <li>We will not be liable for any pre-existing issues/potential risks reported by the technician but not handled due to customer refusal to repair the same</li>
                <li>We do not repair or service built-in Microwaves</li>
