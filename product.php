...
<head>
  ...
  <meta charset="UTF-8">
  <meta name="description" content="Women Fashion Shopping Online - Shop from a huge range of latest women clothing, shoes, makeup Kits, Watches, footwear and more for women at best price in India @ Jabong from Top Brands. Best Online Fashion Shopping *COD *15-Days Returns *Free Shipping.">
  <meta name="keywords" content="Online Shopping Website For Women, Women Fashion Shop, Buy Womens Clothes, Women Apparel Online Shopping India, Ladies Fashion Clothing">
    ...
    <section class="head">
        <div class="row" style="width: 100%;">
            <div class="col-md-12" style="margin-top:0px;margin-bottom:0px;">
                <div class="headerlink col-md-4 col-xs-12" style="margin-top: 5px;">
                    <h5 align="center"><big>&#128383; +91 8442285358</big></h5>   
                </div>
                <div class="col-md-4 col-xs-12" style="margin-top: 5px;">
                    <div class="feature-box" >
                        <div class="icons"> </div>
                        <center><big><h5 align="center"><big><big>&#9993;</big> &nbsp; Email: </b> support@cheapshop.com</big></h5>
                    </div>
                </div>
                <div class="col-md-4 col-xs-12">
                    <div class="feature-box">
                        <a href="#" style="text-decoration:none; color:white; ">   <div class="admission_button"><h5 align="center"><b> Download App</b></h5></div>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <!-- NAVIGATION BAR START  -->
        <nav class="navbar navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a href="index.php" class="navbar-brand">Home Services</a>
            </div>
            <!-- Collection of nav links and other content for toggling -->
            <div id="navbarCollapse" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="index.php">Home</a></li>
                    <li><a href="index.php/#trending">Services</a></li>
          ...
          <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" >
              ...
              <div class="item active">
                <img src="assets/images/banner1.png" id="slider_image"   >
              ...
              <div class="item">
                <img src="assets/images/banner2.png"  class="slider_image" >
                <div class="carousel-caption">
                  <h3></h3>
                  </div>
              </div>
              ...
              <div class="item">
                <img src="assets/images/banner3.png" class="slider_image" >
                <div class="carousel-caption">
                  <h3></h3>
                  </div>
              </div>
...
<div class="row" style="margin-bottom: 25px;">
        <div class="col-md-12"  >
    <div class=" col-md-9 col-xs-12" style="background: white;">
        <div>
            <div style="margin-top: 25px;">
                        <div class="form-group">
                            ...
                            <ol>
              <li> Cooling of the AC depends on multiple factors such as quality of the gas-filled, age of the AC, pressure of the gas etc, and servicing alone does not guarantee improvement in the cooling</li>
              <li>Prices shown are labor charges only</li>
              <li>We provides a 30 day warranty on the service provided</li>
              <li>If any repair work is required, a quote will be given before proceeding</li>
              <li>We strongly discourage direct dealing with our service provider regarding a service booked through us All warranty and service assurance in such cases stand null and void</li>
              <li>Consumables and parts (if used) will be charged extra</li>
              <li>Warranty on consumables and parts will be as per manufacturer only</li>
                           
            </ol>
            <label for="name">Procesure</label>
                            <ol>
              <li>Gas pressure check before start of service</li>
              <li>Check whether the AC in in working condition</li>
              <li>Washing and cleaning of filters</li>
              <li>Cleaning of blower wheels and blades</li>
              <li>Cleaning of indoor cooler drain tray</li>
              <li>Cleaning of water condensation drainage system</li>
              <li>Thorough inspection of the AC unit to check for any leakages in the coils and drain pipeline. In case of an internal leakage, Nitrogen test needs to be done to identify location of leakage, charges for which will be extra</li>
              <li>Check settings of the AC</li>
              <li>Reinstalling of indoor cooler units</li>
              <li>Gas top up , if required and cost approved by the customer</li>
    ...
    <div class=" col-md-3 col-xs-12" >
        <div>
            <div class="card-header bg-success text-white text-uppercase" style="margin-top: 25px; padding: 5px;"><i class="fa fa-home"></i> Address</div>
                <div class="card-body"><Br><br>
                    <p>1 N. Rock Creek Ave.</p>
...
<div class="row" style="background:#EEEEEE;">   
    ...
    <div class=" col-md-3 col-xs-12" >
        <div>
            ...
            <a href="#">Ac</a><br>
            <a href="#">Refrigerator</a><br>
            <a href="#">Tv</a><br>
            <a href="#">Washing Machine</a><br>
            <a href="#">Water Heater</a><br>
    ...
    <div class=" col-md-3 col-xs-12" >
        <div>
            <h3>Our Applications For Mobile</h3>
                <div class=" col-md-6 col-xs-12" >
                    <div>
                        <center><img src="assets/images/play.png" alt="App" width="100%"><center>
                    </div>
                </div>
                <div class=" col-md-6 col-xs-12" >
                    <div>
                        <center><img src="assets/images/app.png" alt="App"  width="100%"><center>
                    </div>
                </div>
                
                <div class=" col-md-12 col-xs-12" >
                    <div>
                        <div style="text-align:center;"><script type="text/javascript" src="http://services.webestools.com/cpt_visitors/61624-13-5.js"></script></div><a href="http://www.webestools.com/" style="display:block;text-align:center;" title="Tools services webmasters counters generators scripts tutorials free"></a>
                    </div>
                </div>
    ...
    <div class=" col-md-3 col-xs-12" >
        <div>
            ...
            <table style="padding:5px;">
                <tr><td>
                <img src="assets/images/original.png" alt="Cheap Shop"></td>
                <td><b>100%  Satisfaction Guarntee </b> <br><br></Td></tr>
                <td><img src="assets/images/return.png" alt="Cheap Shop"></td><td>24X7 Support<br>
                
                <br></td></tr> 
                <td><img src="assets/images/delievery.png" alt="Cheap Shop"></td><td><b>Get Assured Support </b>  </td></tr></table>
        </div>
    </div>
